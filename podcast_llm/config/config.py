...
class PodcastConfig:
    ...
    def load(cls, yaml_path: Optional[str] = None) -> 'PodcastConfig':
        ...
        defaults = {
            ...
            'embeddings_model': 'siliconcloud',
            'tts_provider': 'siliconcloud',
            'tts_settings': {
                'elevenlabs': {
                    'voice_mapping': {
                        'Interviewer': 'Chris',
            ...
            'intro': "欢迎收听 {podcast_name}。今天，我们邀请了一位专家来讨论 {topic}。",
            'outro': "今天就到这里。感谢收听 {podcast_name}。下次再见，我们将谈论您想聊的任何话题。",
            'episode_structure': [
